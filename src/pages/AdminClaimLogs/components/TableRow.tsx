                                 ...
                                 const fetchData = async () => {
                                     try {
                                         ...
                                         const response = await fetch(
                                             `https://recov-backend.vercel.app/api/v1/claim/acceptClaim?claimId=${claimId}`,
                                             {
                                                 method: "PATCH",
                                             }
                                         );
                             ...
                             onReject = (data) => {
                                 const fetchData = async () => {
                                     try {
                                         ...
                                         console.log("Claim ID", claimId);
                                         const response = await fetch(
                                             `https://recov-backend.vercel.app/api/v1/claim/rejectClaim?claimId=${claimId}`,
                                             {
                                                 method: "PATCH",
        ...
        <tr className="border-b-2 p4 p-0">
            <div className="px-10 pb-6 flex flex-col items-start sm:flex-row sm:items-center sm:px-6">
                <div className="px-4 sm:px-6">
                    ...
                    <h1 className="text-gray-500 text-lg">{data.email}</h1>
                </div>
            </div>
